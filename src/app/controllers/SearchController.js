    ...
    async index(req, res) {
        try {
            ...
            async function getImage(productId) {
                ...
                //retorno de um objeto para cada arquivo
            ...
            })).reduce((categoriesFiltered, category) => { //reduce vai fazer um array com os tipos de categorias encontradas não se repitam
